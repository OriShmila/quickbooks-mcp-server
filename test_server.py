...
async def run_tool_test(
    ...
    try:
        ...
        from quickbooks_mcp_server.server import TOOL_FUNCTIONS
        ...
        if test_case.get("should_succeed", True):
            ...
            with open("quickbooks_mcp_server/tools.json", "r") as f:
...
async def test_server_components():
    ...
    try:
        ...
        from quickbooks_mcp_server.server import load_tool_schemas, TOOL_FUNCTIONS
